...
@section('judul', 'Data Peminjaman Ruangan')
@section('content')
    <div class="container-fluid">
        <div class="card card-default">
            <div class="card-header">{{ __('Pengelolaan Peminjaman Ruangan') }}</div>
            <div class="card-body">
                        ...
                        @foreach ($PinjamRuangan as $row)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn  btn-success" href="peminjaman_ruangan/terima/{{$row->id}}"><i class="fa fa-check"></i></a>
                                            <button class="btn btn-xs"></button>
                                            <a class="btn  btn-warning" href="peminjaman_ruangan/tolak/{{$row->id}}"><i class="fa fa-times"></i></a>
                                            <button class="btn btn-xs"></button>
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('admin.peminjaman.ruangan.submit') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <input type="text" name="ruangan" id="ruangan" class="form-control" placeholder="Masukan Nama Barang" />
     ...
     <div class="modal fade" id="editMasukModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('admin.peminjaman.ruangan.update') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ruangan" id="edit-ruangan" required readonly />
                        </div>
                        <div class="form-group">
        ...
        function deleteConfirmation(npm, judul) {
            swal.fire({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "peminjaman_ruangan/delete/" + npm,
                        data: {
                            _token: CSRF_TOKEN
                        },
                        dataType: 'JSON',
...
$('#ruangan').keyup(function() {
    var query = $(this).val();
    if (query != '') {
        var _token = $('input[name="csrf-token"]').val();
        $.ajax({
            url: "{{ url('admin/ruangan/fetch') }}",
            method: "GET",
            data: {
                query: query,
                _token: _token
